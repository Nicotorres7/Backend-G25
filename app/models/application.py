...
class Application(Base):
    ...
    rating_feedback = Column(Text, nullable=True, default=None)
    rating_punctuality = Column(Float, nullable=True, default=None)
    rating_quality = Column(Float, nullable=True, default=None)
    rating_attitude = Column(Float, nullable=True, default=None)
    rated_at = Column(DateTime(timezone=True), nullable=True, default=None)
